...
class CurrenciesControllerTest < ActionController::TestCase
  ...
  test "should create currency" do
    assert_difference('Currency.count') do
      post :create, currency: { base: @currency.base, foreign: @currency.foreign, rate: @currency.rate, user_id: @currency.user_id }
    end
  ...
  test "should update currency" do
    patch :update, id: @currency, currency: { base: @currency.base, foreign: @currency.foreign, rate: @currency.rate, user_id: @currency.user_id }
    assert_redirected_to currency_path(assigns(:currency))
  end
