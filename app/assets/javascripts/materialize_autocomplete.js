(function ($) {
  ...
  *************************/
  $.fn.materialize_autocomplete = function() {
    var settings = $.extend({}, $.fn.materialize_autocomplete.defaults, options);
    ...
    $.fn.materialize_autocomplete.defaults = {
        data: ["Apple","Microsoft","Google"],
        onSelect: function ($element, selection) {
