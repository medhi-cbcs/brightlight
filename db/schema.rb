...
ActiveRecord::Schema.define(version: 20151026153339) do
  ...
  add_index "courses_sections", ["grade_section_id"], name: "index_courses_sections_on_grade_section_id"
  add_index "courses_sections", ["instructor_id"], name: "index_courses_sections_on_instructor_id"
